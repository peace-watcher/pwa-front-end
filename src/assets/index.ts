...
export { default as IcMissingKid } from "./icons/Ic_function_missingKid.svg";
export { default as IcMyFile } from "./icons/Ic_function_myFile.svg";
export { default as IcSearchKid } from "./icons/Ic_function_searchKid.svg";
